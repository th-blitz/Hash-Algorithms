...
#define h0 0x8C3D37C819544DA2
#define h1 0x73E1996689DCD4D6
#define h2 0x1DFAB7AE32FF9C82
#define h3 0x679DD514582F9FCF
#define h4 0x0F6D2B697BD44DA8
#define h5 0x77E36F7304C48942
#define h6 0x3F9D85A86A1D36C8
#define h7 0x1112E6AD91D692A1
...
int main(size_t argv, char* argc[]) {
    ...
    if (argv > 1) {
        for (int i = 1; i < argv; i++) {
            sha512_224_digest(argc[i], strlen(argc[i]), digest, debug);
            for (int i = 0; i < 4; i++) {
                printf("%lx ", digest[i]);
            }
            printf("\n");
        ...
        sha512_224_digest("", 0, digest, debug);
        for (int i = 0; i < 4; i++) {
                printf("%lx ", digest[i]);
            }
        printf("\n");
